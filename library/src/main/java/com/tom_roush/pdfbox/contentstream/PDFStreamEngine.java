...
public abstract class PDFStreamEngine {
    private static final String TAG = "PDFStreamEngine";
    ...
    protected void showText(byte[] string) throws IOException {
        ...
        Log.d(TAG, "showText: 开始文字处理");

        if (BuildConfig.DEBUG) {
            String s = new String(string);
            Log.d(TAG, "showText str: " + s);
        }
        ...
        while (in.available() > 0) {
            ...
            if (BuildConfig.DEBUG) {
                Log.d(TAG, "处理绘制 showText unicode : code=" + code + " , codec: " + ((char) code) + ", codeLength=" + codeLength);
            }
    ...
    protected void showGlyph(Matrix textRenderingMatrix, PDFont font, int code,
        ...
        Log.d(TAG, "showGlyph: " + code + " , unicode: " + unicode + " , displacement: " + displacement);
        if (font instanceof PDType3Font) {
            Log.d(TAG, "showGlyph: -> showType3Glyph");
            showType3Glyph(textRenderingMatrix, (PDType3Font) font, code, displacement);
        } else {
            Log.d(TAG, "showGlyph:  -> showFontGlyph");
    ...
    protected void showGlyph(Matrix textRenderingMatrix, PDFont font, int code, Vector displacement)
            throws IOException {
        Log.d(TAG, "showGlyph: " + code + " , displacement: " + displacement);
    ...
    protected void showFontGlyph(Matrix textRenderingMatrix, PDFont font, int code,
        ...
        // overridden in subclasses
        // call deprecated method to ensure binary compatibility if not overridden
        Log.d(TAG, "showFontGlyph: " + code + " , displacement: " + displacement);
    ...
    protected void showType3Glyph(Matrix textRenderingMatrix, PDType3Font font, int code,
                                  Vector displacement) throws IOException {
        // call deprecated method to ensure binary compatibility if not overridden
        Log.d(TAG, "showType3Glyph: " + code + " , displacement: " + displacement);
